  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Recaura, 6307/95 Liverpool Street, Sydney NSW 2000.
          </p>
      ...
      <ul>
        ...
        <li>
          <strong>Request correction of the Personal Data that We hold about You.</strong> You have the right to to have
      ...
      <ul>
        ...
        <li>
          <strong>From Service Providers</strong>. For example, or other third-party vendors that We use to provide the
          Service to You.
        </li>
      </ul>
